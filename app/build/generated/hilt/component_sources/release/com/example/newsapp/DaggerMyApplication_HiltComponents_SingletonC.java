...
import com.example.newsapp.di.AppModule_ProvideNewsApiFactory;
...
import com.example.newsapp.presentation.news_screen.NewsScreenViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(NewsScreenViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    private Provider<NewsScreenViewModel> newsScreenViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.newsScreenViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.newsapp.presentation.news_screen.NewsScreenViewModel", ((Provider) newsScreenViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.newsapp.presentation.news_screen.NewsScreenViewModel 
          return (T) new NewsScreenViewModel(singletonCImpl.provideNewsRepositoryProvider.get());
